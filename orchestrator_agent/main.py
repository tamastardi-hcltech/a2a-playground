...
def build_agent_card(agent_url: str) -> AgentCard:
    return AgentCard(
        ...
        description=(
            "A multi-agent oracle that consults remote seers and search tools, "
            "then returns one blended prophecy."
        ),
        url=agent_url,
        version="0.1.0",
        ...
        skills=[
            AgentSkill(
                ...
                description=(
                    "Consults remote astrology and search agents, then fuses "
                    "their signals into one mysterious answer."
                ),
